...
Provides 3 Quiz Adapter elements which extend the existing Convoworks WP Plugin.
...
2. When the package is turned on in the configure packages menu then we can see that additionaly to the `convoworks-core` package, there is the `trivia-adapter-pack` package
...
1. You can manually download this package and just paste it into your `wp_content/plugins` folder
